...
#plots
ggplot(plotSum_c2, aes(DistanceC_num, LeftChoice, color = OrientationL)) + 
  geom_point()+
...
ggplot(plotSum_n2, aes(DistanceN_num, LeftChoice, color = OrientationL)) + 
  geom_point()+
  geom_smooth(method=lm) +
  scale_x_continuous(labels=c("-2","-1", "1", "2")) + 
  labs(title="\nExperiment 2",
...
ggplot(plotSum_b2, aes(DistanceB_num, LeftChoice, color = OrientationL)) + 
  geom_point()+
  geom_smooth(method=lm) +
  scale_x_continuous(labels=c("-2","-1", "1", "2")) + 
  labs(title="\nExperiment 2",
